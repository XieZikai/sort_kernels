...
def featurize(x, k=4):
    ...
    for arr in x_copy:
        ...
        feature.append(merge_sort_result + pairwise_feature + shift_hist(arr_copy))
...
def bo_loop(benchmark_index, kernel_type):
    ...
    for nruns in range(20):
        ...
        for num_iters in range(n_init, n_evals):
            ...
            file_name = 'qap_botorch_'+kernel_type+'_EI_benchmark_index_shift_pairwise_'+str(benchmark_index)
